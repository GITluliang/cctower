...
public class AlipayWAPPayController {
    ...
    public void gotoPayPage(@RequestBody AlipayDTO dto, HttpServletResponse response) throws AlipayApiException, IOException {
        ...
        model.setBody(parking.getName() + ": " + parkingRecord.getCarNumber() + "缴费" + dto.getMoney() +"元");
    ...
    public String returnUrl(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException, AlipayApiException {
        ...
        StringBuilder notifyBuild = new StringBuilder("/--------------- alipay returnUrl ---------------/\n");
        ...
        log.info("[alipay returnUrl  校验]: " + verifyResult);
        if (verifyResult) {
            //验证成功
