...
import com.nuoze.cctower.common.exception.BDException;
import com.nuoze.cctower.pojo.dto.ColumnDTO;
import com.nuoze.cctower.pojo.dto.TableDTO;
...
public class GenUtils {
    ...
    public static String getFileName(String template, String classname, String className, String packageName) {
        ...
        if (template.contains("ServiceImpl.java.vm")) {
            return packagePath + "service" + File.separator + "applet" + File.separator + className + "ServiceImpl.java";
        }
