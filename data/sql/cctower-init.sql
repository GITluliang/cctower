...
CREATE TABLE `parking` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
   rent_static tinyint(2) NOT NULL DEFAULT '0' COMMENT '月租车重复出入场：0:禁用 1：启用',
   vip_static tinyint(2) NOT NULL DEFAULT '0' COMMENT 'VIP车重复出入场：0:禁用 1：启用',
   passageway_static tinyint(2) NOT NULL DEFAULT '0' COMMENT '手机开闸：0:禁用 1：启用',
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`) USING BTREE
...
CREATE TABLE `recharge_record` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `open_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'open_id',
  `order_sn` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '订单编号',
  `prepay_id` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '准备支付ID',
  `pay_id` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '支付ID',
  `parking_id` bigint(11) DEFAULT NULL COMMENT '停车场ID',
  `user_id` bigint(11) DEFAULT NULL COMMENT '用户ID',
  `cost` decimal(11,2) DEFAULT NULL COMMENT '充值金额',
  `pay_status` tinyint(2) NOT NULL DEFAULT '0' COMMENT '支付状态',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  ...
  KEY `idx_order_sn` (`order_sn`) USING BTREE,
  KEY `idx_open_id` (`open_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='商户微信充值';